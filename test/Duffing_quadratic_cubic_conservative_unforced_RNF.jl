...
reduced_dynamics_latex_output(DP, aexp, substitutions, "./test/Duffing_quadratic_cubic_conservative_unforced_RNF_output.txt")
nonlinear_mappings_latex_output(DP, aexp, substitutions, "./test/Duffing_quadratic_cubic_conservative_unforced_RNF_output.txt")
