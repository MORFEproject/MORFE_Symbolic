...
output_path = "./test/Duffing_cubic_damped_forced_different_expansion"
...
δ = symbols("δ", real = true, positive = true)   # δ   = 1 - ξ^2
ωd = symbols("ωd", real = true, positive = true) # ωd  = δω
ζ = symbols("ζ", real = true, positive = true)   # ζ   = ξω
                                                 # ω^2 = ωd^2 + ζ^2
...
elseif resonance == "Primary"
    nonautonomous_eigenvalues = [im*ωd;-im*ωd]
elseif resonance == "Superharmonic"
    nonautonomous_eigenvalues = [im*ωd/3;-im*ωd/3]
elseif resonance == "Subharmonic"
    nonautonomous_eigenvalues = [3*im*ωd;-3*im*ωd]
end
