...
conditions = [λ₀[2] =>-λ₀[1], λ₀[3] =>-λ₀[4], 2*λ₀[1] =>λ₀[3]]
...
#             Printing             #
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
reduced_dynamics_latex_output(DP, aexp, "./test/2DOF_oscillator_quadratic_cubic_conservative_unforced_1:2_resonance_CNF_output.txt")
nonlinear_mappings_latex_output(DP, aexp, "./test/2DOF_oscillator_quadratic_cubic_conservative_unforced_1:2_resonance_CNF_output.txt")
